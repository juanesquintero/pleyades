...
class IES:
    def __init__(self, periodo: int):
        ...
        self.programas_periodo_anterior = Data.get_programas_by_periodo(periodo_anterior)
    ...
    def indicadores1(self,):
        try:
            ...
            for v in variables_nombre:
                variables_indicadores.append([data_anterior[v][0], data_actual[v][0]])
    ...
    def indicadores2(self,):
        try:
            ...
            programas_periodo_actual, egresados_periodo_actual  = len(self.programas_periodo_actual), self.data_actual['egresados'][0]
            programas_periodo_anterior, egresados_periodo_anterior = len(self.programas_periodo_anterior), self.data_anterior['egresados'][0]
    ...
    def miniseries_programas(self):
        try:
            ...
            for i,p in enumerate(list_programas):
                ...
                data = data[['periodo','programa','programa_nombre_corto','idprograma','desercion']]
